...
--
-- Name: galaxy galaxies_star_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.galaxy
    ADD CONSTRAINT galaxies_star_id_fkey FOREIGN KEY (star_id) REFERENCES public.star(star_id);
...
--
-- Name: moon moons_planet_id_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.moon
    ADD CONSTRAINT moons_planet_id_fkey1 FOREIGN KEY (planet_id) REFERENCES public.planet(planet_id);


--
-- Name: moon moons_planet_id_fkey2; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.moon
    ADD CONSTRAINT moons_planet_id_fkey2 FOREIGN KEY (planet_id) REFERENCES public.planet(planet_id);


--
-- Name: planet planets_moon_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.planet
    ADD CONSTRAINT planets_moon_id_fkey FOREIGN KEY (moon_id) REFERENCES public.moon(moon_id);
...
--
-- Name: star stars_planet_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.star
    ADD CONSTRAINT stars_planet_id_fkey FOREIGN KEY (planet_id) REFERENCES public.planet(planet_id);
